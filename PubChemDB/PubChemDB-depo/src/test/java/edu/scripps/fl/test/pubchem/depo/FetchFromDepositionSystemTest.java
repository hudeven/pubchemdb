 ...
 */
package edu.scripps.fl.test.pubchem.depo;
...
import edu.scripps.fl.pubchem.depo.OutcomeCount;
import edu.scripps.fl.pubchem.depo.PCDepositionSystemSession;
...
//		org.apache.log4j.Logger.getRootLogger().setLevel(Level.INFO);
		...
		for(int ii = 2; ii < args.length; ii++) {
			...
			OutcomeCount counts = session.getSubstanceOutcomeCounts(aid);
